...
const InitiativesSection = () => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_BASE_URL}/initiatives`)
  ...
  return (
    <Container className="text-center my-5 Initiatives">
      ...
      <div className="d-flex justify-content-center gap-5 my-5 custom-wrap desktoponly flex-wrap">
        ...
        <div className="d-flex flex-column align-items-center px-sm-5 section-2-container border-l-[1px_solid_#ccc] border-r-[1px_solid_#ccc]">
          <Image
            className="section-2-img p-3"
            src={data.eimage}
