...
const AdminCMS = () => {
  ...
  const fetchCMS = async () => {
    const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/cms`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingId ? `${import.meta.env.VITE_API_BASE_URL}/cms/${editingId}` : `${import.meta.env.VITE_API_BASE_URL}/cms`;
  ...
  const handleDelete = async (id) => {
    ...
    await fetch(`${import.meta.env.VITE_API_BASE_URL}/cms/${id}`, {
      method: 'DELETE',
