...
const BIA = () => {
  ...
  return (
    <div>
      {/* Home Banner */}
      <section className="relative overflow-hidden mt-[-170px] h-[calc(75vh+170px)] min-h-[500px]">
        <img
          src={biaBanner}
          alt="BIA Banner"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-[#24140f]/50" />
        <div className="relative z-10 container h-full flex items-center pt-[100px] pb-[50px]">
          <div>
      ...
      <section className="container py-3 py-md-5">
        <div className="row pb-4 pb-md-1">
          ...
          <div className="col-12 col-md-6 my-3 my-md-1 order-1 order-md-2">
            <h3 className="text-[4rem] font-normal text-[#c58c4e]">About BIA</h3>
            <p>
        ...
        <div className="d-flex flex-wrap justify-content-center gap-4 mt-md-5">
          {content.map((item, index) => (
            <div
              className="d-flex flex-column align-items-center border border-[#a36b2c] p-[25px] flex-[1_1_200px] min-w-[260px] max-w-[300px] text-wrap"
              key={index}
            >
      ...
      <section className="bg-[#422a1d] text-white">
          ...
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="d-flex align-items-center gap-3 py-3">
                ...
                />
                <h4 className="text-[4rem] font-normal text-[#c58c4e] m-0">Vision</h4>
              </div>
              <p>
            ...
            <div className="col-12 col-md-6">
              <div className="d-flex align-items-center gap-3 py-3">
                <img
                  ...
                  className="biaVisionMissionImg"
                />
                <h4 className="text-[4rem] font-normal text-[#c58c4e] m-0">Mission</h4>
              </div>
              <p>
      ...
      <section className="container d-flex flex-column align-items-center pt-5 py-md-5">
        <h3 className="text-[4rem] font-normal text-[#c58c4e]">Our Objectives</h3>
        <div className="row my-4">
          {objectives.map((objective, index) => (
            <div
              key={index}
              className="col-6 col-md-3 p-0 relative overflow-hidden group"
            >
              <img
                ...
                height="100%"
              />
              <div className="absolute bottom-0 left-0 right-0 w-full bg-[linear-gradient(to_top,rgba(0,0,0,0.75),rgba(0,0,0,0)_75%)] text-white opacity-100 transition-opacity duration-500 ease-in-out p-[1rem] box-border group-hover:bg-[linear-gradient(to_top,rgba(0,0,0,0.85),rgba(0,0,0,0)_85%)]">
                <p>
      ...
      <section className="bg-[#fffbf5]">
        <div className="container d-flex flex-column align-items-center py-5">
          <h3 className="text-[4rem] font-normal text-[#c58c4e]">Key Activities</h3>
          <div className="mt-3">
            <div className="row">
              {activities.map((activity, index) => {
                ...
                return (
                  <div
                    ...
                    } py-4 gap-4 ${!isLastItem ? 'border-b border-[#b27f4a]' : ""}`}
                  >
                    <img
                      src={activity.imgSrc}
                      alt={activity.title}
                      className="w-[200px] h-[250px] transition-all duration-500 ease-in-out hover:scale-[1.03]"
                    />
                    <div
                      className={`'max-w-[300px] leading-[1.5] '+
                        !isLastItem ? "" : "mw-100"
                      }`}
                    >
                      <h4
                      ...
                      {activity.details.map((item, i) => (
                        <p key={i}>
                          <span className="text-[#a36b2c]">{item.label}:</span>{" "}
                          {item.text}
                        </p>
                      ))}
                    </div>
      ...
      <section
        ...
        id="membership"
      >
        <h4 className="text-[4rem] font-normal text-[#c58c4e] text-center">Membership Plans</h4>
        <h5 className="text-center">
          Explore our various levels of industry engagement and benefit.
        </h5>
        <div className="btn-group mt-2 [&>button]:bg-[#af7f4b] [&>button]:border-[#af7f4b] [&>button.inactive]:bg-white [&>button.inactive]:text-black">
          <Button
            type="button"
        ...
        <div className="row mt-4 w-100 d-none d-md-flex">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`col-6 col-md-3 border border-[#a36b2c] p-[25px] bg-[#fffbf4] transition-all duration-500 ease-in-out hover:scale-[1.02] hover:shadow-[0_8px_12px_rgba(0,0,0,0.2)] hover:z-[5] ${
        ...
        <button
          key={2}
          className="px-4 py-2 btn btn-light mt-sm-5 border-button !bg-[#b27f4a] !text-white !border-none hover:!bg-[#c28b4f]"
          onClick={() => setModalShow(true)}
        >
          <strong className="text-[12px] font-bold">BECOME A MEMBER</strong>
        ...
        <div className="d-flex flex-wrap justify-content-center gap-3 gap-md-4 mt-4">
          {differentiator.map((item, index) => (
            <div
              className={`d-flex flex-column align-items-center h-[150px] min-w-[200px] max-w-[350px] border border-[#a36b2c] p-[25px] text-wrap w-[45%] ${item?.class}`}
              key={index}
            >
              <img src={item.imgSrc} alt="" height={50} width={50} />
              <div className="text-center pt-2">
      ...
      <div className="d-flex flex-column align-items-center">
        <h4 className="text-[4rem] font-normal text-[#c58c4e] mb-4">Our Chapters</h4>
      ...
      <section className="container d-flex flex-column align-items-center py-5">
        <h4 className="text-[4rem] font-normal text-[#c58c4e]">Way Forward</h4>
          ...
          {forwardItems.map((item, index) => (
            ...
            >
              <img
                src={item.imgSrc}
                alt={item.label}
                className="hover:shadow-[0px_4px_12px_rgba(238,238,238,0.81),0px_0px_16px_rgba(197,195,183,0.81)]"
                height={100}
                width={200}
              />
              <div className="max-w-[300px] leading-[2]">
                <p className="m-0">
                  <b>
                    <span className="text-[#a36b2c]">{item.label}:</span>
                  </b>{" "}
  ...
  <div className="d-flex justify-content-center text-black">
    <h4
      className="mb-4 text-[4rem] leading-[1] text-black"
