...
import MeetOurVisionaryLeader from "../../components/home/MeetOurVisionaryLeader1.jsx";
...
>
  ...
  <div className="container text-white">
    ...
    <h2
      key={1}
      className="font-['Bebas_Neue_Pro_Regular',serif] tracking-tighter"
    ...
    >
      ...
      <section className="container py-3 py-md-5">
        <div className="row pb-4 pb-md-1">
          <div className="col-12 col-md-6 my-3 my-md-1">
            <h3 className="text-[4rem] font-normal text-[#c58c4e]">About Us</h3>
            <h4 className="font-['Neulis_Sans_Medium']">
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="d-flex align-items-center gap-3 pb-3">
                <h4 className="text-[4rem] font-normal text-[#c58c4e] m-0">Our Social Impact</h4>
              </div>
              <h4 className="font-['Neulis_Sans_Medium']">
      ...
      <section className="bg-[rgb(66,42,29)] text-white">
        <div className="container py-5">
          ...
          <div className="d-md-flex justify-content-between mt-5">
            <div className="w-md-50">
              <h2 className="font-['Neulis_Sans_Medium']">Membership in BITO</h2>
              <p>
            ...
            <button className="btn btn-light border-button py-[20px] px-[70px] rounded-[50px] text-[30px] bg-transparent border-white flex justify-center items-center gap-[30px] text-white fs-2">
              Enroll Now{" "}
    ...
    <Tabs defaultActiveKey="01" id="our-initiative" className="my-4 border-0">
      ...
      <Tab eventKey="07" title="07">
       ...
       <div className="row pt-lg-5 pb-4 pb-md-1">
            <div className="col-12 col-md-6 my-3 my-md-1">
              <h3 className="text-[4rem] font-normal text-[#c58c4e]">Organizational Structure:</h3>
