  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide className="mt-10 sm:mt-0 h-100 py-[50px] bg-[url('../assets/banners/Banner02.jpg')] bg-cover bg-center bg-no-repeat min-[800px]:max-[1200px]:py-[16pc] min-[600px]:max-[1000px]:py-[800px]! max-[1000px]:bg-[url('../assets/home-banner/slider2.jpg')]"
        >
