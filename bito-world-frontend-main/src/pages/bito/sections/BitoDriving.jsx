    ...
    return (
        <>
                ...
                <Row>
                    <Col sm={12} md={6} lg={6}>
                        ...
                        <ol className='pt-3 propelling'>
                            <li className='text-[15px]'>Propelling industrial development</li>
                            <li className='text-[15px]'>Fostering innovation</li>
                            <li className='text-[15px]'>Industrial advocacy</li>
                            <li className='text-[15px]'>Facilitating collaboration</li>
                            <li className='text-[15px]'>Driving sustainable growth aligned with 17 SDGs - UN in Bihar and beyond</li>
                        </ol>
            ...
            <Container className="association py-4 member-container">
                <Row>
                    <Col sm={12} md={6} lg={6} className='image-r relative min-[900px]:relative order-last  order-sm-first'>
                        <div className='image-p min-[900px]:max-[1400px]:absolute min-[900px]:max-[1400px]:-left-[55px] min-[900px]:max-[1400px]:right-0 min-[1401px]:absolute min-[1401px]:-left-[104px] min-[1401px]:right-0'>
                        ...
                        <Col className="mission-vision-row-col-1" lg={6}>
                            <div className="vision">
                                ...
                                >
                                    ...
                                    <span className='text-[#ce9d68]'>Vision</span>
                                </div>
                        ...
                        <Col className="mx-auto mission-vision-row-col-2" lg={6}>
                            <div className="mission">
                                ...
                                >
                                    ...
                                    <span className='text-[#ce9d68]'>Mission</span>
                                </div>
                                <p className="text-white">
