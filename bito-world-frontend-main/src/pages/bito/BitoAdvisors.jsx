...
const BitoAdvisors = (props) => {
    ...
    return (
        <div>
            {/* Banner Section */}
            <section className="relative overflow-hidden mt-[-170px] min-h-[500px] ">
                <img
                    src={AdvisorBanner}
                    alt="BITO Advisors Banner"
                    className="absolute inset-0 w-full h-full object-cover mt-10"
                />
                <div className="absolute inset-0 bg-[#24140f]/50" />
                <div className="relative z-10 container h-full flex items-end pb-10 pt-[200px]">
