...
// Backward-compatible root aliases for existing frontend calls and direct requests
app.use('/auth', authRoutes);
app.use('/banner', bannerRoutes);
app.use('/bodies', bodiesRoutes);
app.use('/chapter', chapterRoutes);
app.use('/cms', cmsHomeRoutes);
app.use('/galleries', galleriesRoutes);
app.use('/galleries-image', galleriesImageRoutes);
app.use('/initiatives', initiativesRoutes);
app.use('/mission', missionRoutes);
app.use('/objective', objectiveRoutes);
app.use('/organization', organizationRoutes);
app.use('/roadmap', roadmapRoutes);
app.use('/actionpoints', actionpointsRoutes);
